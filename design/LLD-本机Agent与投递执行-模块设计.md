...
> 文档版本：2026-08-16 · v1.3（交付级 LLD，首选模块；v1.1 修复 F-1/F-2/F-3；v1.2 修复评审 F-4~F-14 + 收口 R-09；v1.3 补 §5.4 多设备调度冲突消解 + §8.4 本地存储治理，闭合 HLD §27.1/§25.5）
> 编写依据：LLD 交付标准（IEEE 1016-2009 设计视图 / GB-T 8567—2006 详细设计 / Amazon LLD 模板 / 中文《详细设计说明书》共识）
> 关联上游：HLD v3.22（§2 / §3.4 / §4.6 / §5.4 / §6.14 / §25.5 / §27.1）× PRD v4.5
