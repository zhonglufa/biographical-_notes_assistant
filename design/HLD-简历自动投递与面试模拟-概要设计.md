...
> 2026-08-16 · **v3.31（部署运维手册收口 #171）**：架构师自主推进 P2 文档交付第二块，闭合审查报告 P2「部署运维手册」。新建 `design/部署运维手册.md` v1.0：把 HLD 分散的部署形态(§2.5)/韧性(§6.14/§C)/发布治理(§28)/可观测(§31.5)/事件响应(§24)/第三方韧性(§31.3)决策收敛为可执行手册，覆盖服务端+本机Agent双侧部署、自更新回滚(§29.3/§30.7)、本地降级(§C.D)、SLI/SLO+deadman、SEV分级+kill switch、压测混沌、备份DR、灰度自动回滚guardrail(§31.12)、数据迁移；闭合 R-06/R-08 长尾部分，显式登记 §13 缺口（Mock fixtures/日志 schema/Pact/PIPL三块/无障碍）。§9.4 新增部署运维手册行标 [闭环]；剩余 #170 风险登记表复评。
